            ...
            else
            {
              ...
              * this.parent.scale.x;
                ...
                if (this.options.right !== null)
                {
                    if (
                        this.parent.right > (
                            this.options.right === true ? this.parent.worldWidth : this.options.right as number
                        )
                    )
                    {
                        this.parent.x
            ...
            else
            {
              ...
              * this.parent.scale.y;
                ...
                if (this.options.bottom !== null)
                {
                    if (
                        this.parent.bottom > (
                            this.options.bottom === true ? this.parent.worldHeight : this.options.bottom as number
                        )
                    )
                    {
                        this.parent.y
